...
def test_staging_table_sql(test_path, data_vault_load):
    """
    Compares staging table creation SQL generated by DataVaultLoad with the expected
    results.
...
def test_staging_table_with_role_playing_sql(
    test_path, data_vault_load_with_role_playing
):
    """
    Compares staging table creation SQL generated by DataVaultLoad with the expected
    results.
    ...
    Args:
        test_path (Path): test_path fixture value (defined in conftest.py).
        data_vault_load_with_role_playing (DataVaultLoad):
            data_vault_load_with_role_playing fixture value (defined in conftest.py).
    """
    expected_results = (
...
def test_data_vault_load_sql(test_path, data_vault_load):
    """
    Compares full DataVault load script generated by DataVaultLoad with the expected
    results.
...
def test_data_vault_load_with_role_playing_sql(
    ...
    Args:
        test_path (Path): test_path fixture value (defined in conftest.py).
        data_vault_load (DataVaultLoad): data_vault_load_with_role_playing fixture value
